	...
	<div class="container">
		...
		<div class="row">
			<div class="span-one-third">
			    ...
			    <ul><li><a href="/auth/">WebID authentication</a></li>
			...
			<div class="span-one-third">
				<h3>Learn</h3>
				<p>The best way to learn how to use the MyProfile REST API is reading through the <a href="docs/">Documentation</a>.</p>
				<p>Another good resource is the <a href="#">Github Wiki</a> (soon).</p>
				<p>You may also want to take a look at several <a href="#">examples</a> (soon).</p>
                <h3>Contribute</h3>
				<p>Use the links below to get contributing.</p>
				<ul>
					<li><a href="https://github.com/MyProfile/rest-api">GitHub Respository</a></li>
					<li><a href="https://github.com/MyProfile/rest-api/issues">Issue Tracker</a></li>
				</ul>
			</div>https://github.com/MyProfile/rest-api
		</div>
		<div class="row">
		    <p></p>
